          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                <span className="text-xs font-mono font-bold text-white">{specialAction.label}</span>
                <span className="text-[11px] text-zinc-400 truncate font-semibold">Mentionner un post</span>
              </div>
