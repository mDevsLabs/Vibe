...
export const maiModelsList: MAIModelDetail[] = [
  {
    ...
    description:
      "mAI-2 is the next-generation flagship cloud model of the mAI family, designed for advanced reasoning, coding, and long-context tasks.",
    huggingFaceTag: "mDevsLabs/mAI-2",
    id: "mai-2",
    license: "MIT",
    ...
    recommendedHardware: {
      minVram: "Cloud",
      ram: "Cloud",
      recommendedVram: "Cloud",
    },
    releaseDate: "2026-09-09",
    status: "active",
    tagline: "Next-gen flagship cloud intelligence.",
    version: "2.0.0",
    vision: true,
  },
  {
    ...
    description:
      "mAI-2-Mini is the fast and efficient cloud model of the mAI family, optimized for speed and everyday tasks.",
    huggingFaceTag: "mDevsLabs/mAI-2-Mini",
    id: "mai-2-mini",
    license: "MIT",
    maxOutputTokens: 128_000,
    multimodal: false,
    name: "mAI-2-Mini",
    ollamaTag: "mDevsLabs/mAI-2-Mini",
    parameters: "N/A",
    recommendedHardware: {
      minVram: "Cloud",
      ram: "Cloud",
    ...
    releaseDate: "2026-09-09",
    status: "active",
    tagline: "Fast and efficient cloud intelligence.",
    version: "2.0.0",
    vision: true,
  },
  {
